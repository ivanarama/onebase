...
- оставшийся долг — inline handlers в query/dev tools и админках. Их нужно
  выносить отдельными PR через явный bootstrap JSON/data-атрибуты и браузерную
