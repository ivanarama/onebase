# План 152: AI-инструменты разработчика — довести до сильного продукта

> Номер сменён с 74 на 152 (issue #1035): под 74 жили разные планы, и ссылка «план 74» перестала быть однозначной. Номер 74 остался за планом «Realtime-push в основном UI» (74-realtime-sse-push). Ссылки «план 74» на эту тему читать как «план 152».
