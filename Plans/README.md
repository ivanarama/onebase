...
| 130 | [130-document-write-paths.md](130-document-write-paths.md) | Одна точка записи документа: свести три реализации (Save, docWriter, postDocument) | ⬜ Проект 2026-08-18 (issue #962, находка Н3). Номер 130: исходный 124 столкнулся с занятым веб-примитивами (ветка #972 нумеровалась раньше). Рекомендация: сперва паритет отказов тестом, потом общий шов; полное сведение — направление, не задача |
