...
| 118 | [118-list-detail-panel.md](118-list-detail-panel.md) | Боковая панель деталей активной записи списка (+ закладки внутри панели) | ⬜ Проект 2026-08-09 (issue #670), не начато. Этапы 118A и 118B самодостаточны |
...
| 36 | [36-dsl-language-roadmap.md](36-dsl-language-roadmap.md) | 🟡 Приоритет 1 закрыт. Из приоритета 2 отсутствуют: `Выбор Когда` в скриптовом DSL, именованные параметры, деструктуризация, `Символы.ПС/Таб`, `Подождать`, `СгенерироватьGUID`, `ОбработкаПроверкиЗаполнения`, глобальные подписки на события |
