...
| 121 | [121-stages.md](121-stages.md) | Этапы: декларативные состояния сущности, транзакционный гейт переходов в обеих точках записи storage, история переходов, отчёт «где застряло», схема на ECharts | ⬜ Проект 2026-08-12 (по итогам разбора плана 85), не начато. 16–21 день, минимальный срез 9–12: учтены конкурентная сериализация, backup/restore и provenance обмена. Не заводит новый вид объекта метаданных — блок `stages` у существующей сущности |
