...
5. ~~**План 114** (`onebase doctor`)~~ ✅ **Закрыт** (2026-08-03, ветка
...
6. ~~**План 88E**~~ ✅ **Закрыт** (2026-08-03, ветка
...
7. **Планы 79 / 79F** — доводка строкового контура доступа (см. таблицы ниже).
8. Стратегические, каждый отдельным проектом: **82** (полнотекстовый поиск),
