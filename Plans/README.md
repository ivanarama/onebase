...
| 36 | [36-dsl-language-roadmap.md](36-dsl-language-roadmap.md) | 🟡 Приоритет 1 закрыт. Из приоритета 2 отсутствуют: `Выбор Когда` в скриптовом DSL, именованные параметры, деструктуризация, `Символы.ПС/Таб`, `XMLСтрока/XMLЗначение`, `СгенерироватьGUID`, `ОбработкаПроверкиЗаполнения`, глобальные подписки на события |
