...
| 119 | [119-inforeg-write-api.md](119-inforeg-write-api.md) | Программная запись регистров сведений из DSL (менеджер записи, набор записей) | 🟡 Проект 2026-08-11 (issue #743). 119A (менеджер записи) влит — PR #753, 2026-08-11; 119B (набор записей) и 119C (линт) не начаты |
