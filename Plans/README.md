...
| 92 | [92-platform-selfupdate.md](92-platform-selfupdate.md) | Автообновление платформы: каналы build/stable, кнопка в лаунчере, сетевой `onebase update` | ⬜ Проект (ядро подмены бинаря уже есть в `internal/selfupdate`; нужны источник из сети и UI) |
