...
5. ~~**План 88E**~~ ✅ **Закрыт** (2026-08-03, ветка
...
6. **Планы 79 / 79F** — доводка строкового контура доступа (см. таблицы ниже).
7. Стратегические, каждый отдельным проектом: **82** (полнотекстовый поиск),
