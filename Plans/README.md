...
5. ~~**План 82** (полнотекстовый поиск)~~ ✅ **Закрыт** (2026-08-03, ветка
...
6. **Планы 88E / 79 / 79F** — доводка контуров доступа (см. таблицы ниже).
7. Стратегические, каждый отдельным проектом: **84** (enterprise-auth),
