...
| 118 | [118-list-detail-panel.md](118-list-detail-panel.md) | Боковая панель деталей активной записи списка (+ закладки внутри панели) | 🟡 118A–118C сделаны (панель, автокомпоновка, блок `detail_panel:`); 118D частично — ленивый хендлер панели записи есть (#860), вкладки ТЧ и вложений нет |
...
| 122 | [122-startup-smoke-and-platform-gates.md](122-startup-smoke-and-platform-gates.md) | Гейты запуска: smoke-запуск собранного бинаря из общего каталога, Windows-раннер в CI, гейт публикации релиза, типизированная «невозможность самообновления» | 🟡 Ядро этапа C закрыто PR #804 по issue #782: `release.yml` ждёт зелёный CI на том же коммите, права сужены; инструкция по депубликации не добавлена, у гейта открыт дефект #874. Остальное (A — smoke собранного бинаря, B — Windows-раннер, D — типизированная «невозможность самообновления», E, F) не начато — заявка #876 |
