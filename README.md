...
- **`onebase init` кладёт в проект `AGENTS.md`** — полное руководство, сгенерированное
...
169 функций, 160 методов объектов, 19 конструкций и 37 элементов языка запросов,
