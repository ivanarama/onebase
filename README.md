...
- PostgreSQL 14+ (локально или сетевой) — для многопользовательской работы
...
| Информационная база | SQLite-файл или PostgreSQL | Прикладные таблицы + `_users` + `_onebase_config` |
