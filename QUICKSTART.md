...
- [`docs/dsl-reference.md`](docs/dsl-reference.md) — справочник встроенного языка: 155 функций, 150 методов, язык запросов. Генерируется из платформы, разойтись с ней не может.
