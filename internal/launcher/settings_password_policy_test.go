...
func policyBase(t *testing.T, baseID string) (userID string, saveSettings func(string) *httptest.ResponseRecorder, passwd func(string) *httptest.ResponseRecorder, settingsHTML func() string) {
	t.Helper()
	...
	return user.ID, saveSettings, passwd, settingsHTML
}
...
func TestSettingsPasswordPolicyEnablesEmptyPassword(t *testing.T) {
	_, saveSettings, passwd, _ := policyBase(t, "pw-policy-empty")
...
func TestSettingsPasswordPolicyAppliesMinLength(t *testing.T) {
	_, saveSettings, passwd, _ := policyBase(t, "pw-policy-len")
...
func TestSettingsPasswordPolicyRejectsOutOfRange(t *testing.T) {
	_, saveSettings, _, _ := policyBase(t, "pw-policy-range")
...
func TestSettingsPasswordPolicyShowsEffectiveValues(t *testing.T) {
	...
	_, _, _, settingsHTML := policyBase(t, "pw-policy-env")
