...
// Заголовки — дословно те же, что у галочек в конфигураторе («Параметры базы» →
// «Безопасность»): человек ищет в UI ровно ту строку, которую увидел в консоли.
var guards = []guard{
	{
		key:   "net.enabled",
		title: "Разрешить сетевые операции конфигурации",
	...
	{
		key:   "exec.enabled",
		title: "Разрешить выполнение команд ОС",
