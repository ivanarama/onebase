...
Проверки:
  ...
  refs               ссылки на несуществующие объекты: реквизиты, ТЧ,
                     измерения регистров, субконто бухрегистра [чинит: очистить]
  codes              пустые и повторяющиеся коды и номера       [чинит: renumber]
