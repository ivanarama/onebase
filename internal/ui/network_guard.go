...
// Текст называет и пункт меню, и ключ настройки с командой: в headless-окружении
// (CI, автопрогон на свежей базе) до конфигуратора не дойти, и сообщение про
// «Система → Настройки» там не помогало ничем (#709).
var ErrNetworkLocked = errors.New("сетевые возможности отключены предохранителем — включите «Разрешить сетевые операции» в конфигураторе (Система → Настройки) либо командой: onebase settings set net.enabled вкл")
