...
// ── Отбор подбора: подчинённые справочники (`owner:`) ────────────────────────
//
// ПОДЧИНЁННЫЙ СПРАВОЧНИК (`owner:` у справочника, 1С: «Владелец»). Договор
...
// чужой список, не понимая почему. Явно объявите ровно один реквизит-владелец.
