...
{{$el := .El}}{{$ctx := .Ctx}}{{$ro := effectiveFormElementReadOnly $ctx.Form $el}}{{$effectiveReq := effectiveFormElementRequired $ctx.Entity $el}}{{$req := nativeFormElementRequired $ctx.Entity $el}}
