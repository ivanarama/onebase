...
// создаёт свёртка базы (план 151). Не соответствует никакой сущности
...
// ── Свёртка регистров бухгалтерии (акк_*, план 151) ───────────────────────────
...
// ── Обрезка периодических регистров сведений (план 151, опционально) ───────────
//
...
// ── Дата запрета проведения (план 151) ────────────────────────────────────────
...
// guard'ами проведения (план 151) в ui/entityservice.
