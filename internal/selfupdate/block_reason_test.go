...
// нормальный случай.
//
// На Windows этот тест держит ещё и границу «внутри профиля»: t.TempDir() лежит
// в профиле, но приходит 8.3-псевдонимом (`C:\Users\RUNNER~1\…` при профиле
// `C:\Users\runneradmin`). Пока сравнение путей было текстовым, личный каталог
// в короткой записи объявлялся общей установкой — та самая ложная причина, из-за
// которой заведена #1065.
