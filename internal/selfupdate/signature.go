...
//
// Переход мягкий по решению владельца: сначала релизы подписываются, а
// обновление подпись ПРОВЕРЯЕТ, но не ТРЕБУЕТ. Иначе первая же подписанная
// версия оборвала бы автообновление всем, кто стоит на сборках без подписи, —
// и чинить это пришлось бы руками на каждой машине.
